            ...
            <div class="row">
                <div class="col-sm-2">
                    <div class="companyinfo">
                        <h2><span>Sell</span>-man</h2>
                        <p>Our product home seller on your house.If you should cheaking our seller man.</p>
                    </div>
                </div>
                <div class="col-sm-7">
                    <?php $sellmans=DB::table('sell_men')
                         ->where('status',1)
                         ->get();
                    ?>
                        ...
                        <div class="video-gallery text-center">
                            <a href="#">
                                <div class="iframe-img">
                                    ...
                                    <img src="/storage/sellman/{{$sellman->sell_image}}" style="width:120px;" alt="Sell Man Image">
                                </div>
                                <div class="overlay-icon">
                                    <i class="fa fa-play-circle-o"></i>
                                </div>
                            </a>
                            <p>{{$sellman->sellman_name}}</p>
                            <h2>{{$sellman->created_at}}</h2>
                        </div>
                    </div>
                        @endforeach
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-3 col-sm-offset-1">
                    <div class="single-widget">
                        <h2>Subcriber</h2>
                        <form action="{{URL::to('subcriber')}}" method="POST" class="searchform" >
                            <input type="email" name="subcriber" placeholder="Your email address" />
