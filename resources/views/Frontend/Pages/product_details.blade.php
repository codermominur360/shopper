        ...
        <div class="product-details"><!--product-details-->
            <div class="col-sm-5">
                <div class="view-product">
                    <img src="{{asset('/fontend/images/product-details/1.jpg')}}" alt="" />
                    <h3>ZOOM</h3>
                </div>
...
{{--                    </div>--}}
            ...
            <div class="col-sm-7">
                <div class="product-information"><!--/product-information-->
                    ...
                    <h2>{{$productDetials->product_name}}</h2>
                    ...
                    <p><b>Availability:</b> {{($productDetials->status)== 0 ?'Active':'No-Stock'}}</p>
                    <p><b>Condition:</b> New</p>
                    <p><b>Brand:</b> {{$productDetials->menufacture_name}}</p>
                    <p><b>Size:</b> {{$productDetials->product_size}}</p>
                    <p><b>Category:</b> {{$productDetials->category_name}}</p>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade active in" id="reviews" >
                    <div class="col-sm-12">
                        ...
                        <p>{{$productDetials->product_long_description}}</p>
