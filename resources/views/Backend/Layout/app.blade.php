        ...
        <div id="sidebar" class="nav-collapse ">
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{URL::to('/product/create')}}">Product Add</a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{URL::to('/category/create')}}">Category Add</a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{URL::to('/menufacture/create')}}">Brand Add</a></li>
                        <li><a href="{{URL::to('/menufacture')}}">Brand List</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="{{URL::to('/sliderImage')}}">
                        <i class="fa fa-tasks"></i>
                        <span>Slider</span>
                    </a>
                </li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{URL::to('sellman')}}">Delivery Man List</a></li>
                        <li><a href="{{URL::to('/sellman/create')}}">Delivery Man Add</a></li>
                    </ul>
                </li>
                <li>
                    <a href="">
